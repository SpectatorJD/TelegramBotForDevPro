package com.example.TelegramBotForDevPro.controller.person;
...
class CustomerControllerTest {
    ...
    @BeforeEach
    void setUp() {
        Customer customer1 = new Customer("Ivan", "Ivanov", 1000000001L);
        customer1.setId(10001);
        Customer customer2 = new Customer("Petr", "Petrov", 1000000002L);
